        ...
        <div className="container flex items-center justify-center min-h-screen px-6 mx-auto">
            <form className="w-full max-w-md">
                ...
                <div className="flex items-center justify-center mt-6">
                    <a href="/sign-in" className="w-1/3 pb-4 font-medium text-center text-gray-500 capitalize border-b">
                        sign in
                    </a>

                    <a href="/sign-up" className="w-1/3 pb-4 font-medium text-center text-gray-800 capitalize border-b-2 border-blue-500">
                        sign up
                    </a>
                </div>
                ...
                <div className="mt-6">
                    ...
                    <div className="mt-6 text-center ">
                        <a href="/sign-in" className="text-sm text-blue-500 hover:underline">
