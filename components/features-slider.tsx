...
export default function FeaturesSlider() {
    ...
    return (
        <div>
            <ul className="px-5 lg:px-40 flex flex-col lg:flex-row justify-center list-none mb-20 lg:mb-30 xl:mb-50">
                {FeaturesMenu.map((menuItem, index) => (
                    <li key={index} className={`flex-1 first:border-t-1 lg:first:border-t-0 text-center text-lg text-neutral-500 font-medium border-b-1 border-neutral-300
                        ...
                        <button onClick={() => setActiveMenuItem(menuItem)}
                            className={`cursor-pointer py-4 w-52 lg:w-64 hover:text-red-400
                                 ...
                                 mb-65`}>
                                    <Image
                                        ...
                                        className={`absolute ${activeMenuItem === 'Simple Bookmarking'
                                            ...
                                            : '-bottom-70 lg:-bottom-60 scale-80 lg:scale-100 xl:left-15'}
                                              2xl:scale-110 z-10`}
                                    />
                                    <div
                                        className="absolute z-5 w-300 bg-blue-600 rounded-r-full
                                        -bottom-68 xl:-bottom-75
                                        -left-220 xl:-left-200
                                        h-55 xl:h-75 " />
                                </div>
