...
export default function Hero() {
    return (
        <div className="px-5 sm:px-20 xl:px-40 2xl:px-80 pt-25 sm:pt-35 md:pt-50">
            {HeroCopy.map((item, index) => (
                <div key={index} className="flex flex-col-reverse lg:flex-row pb-40 items-center">
                    <div className="flex-1 flex-col text-center lg:text-left items-center justify-center">
                        <h1 className="font-bold text-3xl sm:text-5xl lg:text-4xl text-blue-950 mb-8">{item.heading}</h1>
                    ...
                    <div className="flex-1 overflow-visible relative pb-50 w-100
                        ...
                        <Image
                            ...
                            scale-100 sm:scale-120 lg:scale-100 2xl:scale-110"
                        />
